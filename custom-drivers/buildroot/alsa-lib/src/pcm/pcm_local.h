...
#define SA_ROOMPLAYER 1

/* ***SIMPLE AUDIO ROOMPLAYER DEFINES, PROTOTYPES AND INCLUDES *** */
#ifdef SA_ROOMPLAYER

#include <string.h>
#include <math.h>

#define SYSCALL_CLOCK_CHANGE 441
#define SA_CARD_NUMBER 0
#define SA_DEVICE_NUMBER 0
#define SA_SUBDEVICE_NUMBER 0
#define SA_MAX_RATE 192000
#define SA_DSD_RATE 176400
#define SA_24_576_MHZ_CLOCK 24576000
#define SA_11_2896_MHZ_CLOCK 11289600
#define SA_SYSTEM_CALL_BUFFER 70

#define SA_CLOCK_SELECT_24_576_MHZ 1
#define SA_CLOCK_SELECT_11_2896_MHZ 0

#define SA_GPIO_492 492
#define SA_GPIO_491 491
#define SA_GPIO_EXPORT "/sys/class/gpio/export"
#define SA_GPIO_UNEXPORT "/sys/class/gpio/unexport"
#define SA_GPIO_491_VALUE "/sys/class/gpio/gpio491/value"
#define SA_GPIO_492_VALUE "/sys/class/gpio/gpio492/value"
#define SA_GPIO_WRITE "w"

#define _SA_TO_NUMBER(x) #x
#define SA_TO_NUMBER(x) _SA_TO_NUMBER(x)

#define SA_SYSTEM_BUFFER 100

#define SA_GPIO_TRUE 1
#define SA_GPIO_FALSE 0
#define SA_DIR 0

void set_clock_gpio(int clk);
void set_kernel_clock_gpio(unsigned int rate);
void set_kernel_clock(unsigned int clock);
int get_clock_to_set(unsigned int rate);
void set_kernel_snd_card_clock(unsigned int clock);
unsigned int write_file(char* path, int message);
